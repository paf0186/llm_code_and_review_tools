...
from gerrit_cli.reintegration import ReintegrationState
...
class TestSessionManager:
    ...
    def test_init_default_dir(self):
        ...
        with patch('gerrit_cli.session.Path.cwd') as mock_cwd:
            mock_cwd.return_value = Path('/test/dir')
            with patch.object(Path, 'mkdir'):
                mgr = SessionManager()

        assert mgr.state_dir == Path('/test/dir') / ".gerrit-cli"
