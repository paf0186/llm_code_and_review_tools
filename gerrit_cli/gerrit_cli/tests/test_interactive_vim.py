...
from gerrit_cli.interactive_vim import (
    InteractiveVimSession,
    run_interactive_vim,
)
from gerrit_cli.tmux_vim import TmuxConfig, TmuxVimSession
...
class TestInteractiveVimSession:
    ...
    def test_handle_edit_success(self, mock_session):
        ...
        with patch('gerrit_cli.interactive_vim.work_on_patch', return_value=(True, "Started")):
    ...
    def test_handle_edit_failure(self, mock_session):
        ...
        with patch('gerrit_cli.interactive_vim.work_on_patch', return_value=(False, "Failed")):
            result = mock_session._handle_edit()
