...
from gerrit_comments.rebase import (
    RebaseManager,
    RebaseSession,
    abort_patch,
    end_session,
...
from gerrit_comments.series import PatchInfo
...
class TestRebaseManager:
    ...
    @patch("gerrit_comments.rebase.Path")
    ...
    def test_check_git_repo_not_in_repo(self):
        ...
        with patch("gerrit_comments.rebase.git_utils.check_git_repo") as mock_check:
    ...
    def test_check_git_repo_dirty_working_tree(self):
        ...
        with patch("gerrit_comments.rebase.git_utils.check_git_repo") as mock_check:
            with patch("gerrit_comments.rebase.git_utils.is_working_tree_clean") as mock_clean:
    ...
    def test_get_current_branch(self):
        ...
        with patch("gerrit_comments.rebase.git_utils.get_current_branch") as mock_branch:
    ...
    def test_get_current_commit(self):
        ...
        with patch("gerrit_comments.rebase.git_utils.get_current_commit") as mock_commit:
    ...
    @patch("gerrit_comments.rebase.extract_comments")
    @patch("gerrit_comments.rebase.SeriesFinder")
...
class TestModuleFunctions:
    ...
    @patch("gerrit_comments.rebase.RebaseManager")
...
class TestReintegration:
    ...
    def test_start_reintegration_single_stale(
        ...
        from gerrit_comments.series import PatchInfo, PatchSeries, StaleChangeInfo
