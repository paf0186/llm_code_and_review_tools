...
class TestParserCreation:
    ...
    def test_add_extract_parser(self):
        ...
        from gerrit_comments.parsers import add_extract_parser
    ...
    def test_add_reply_parser(self):
        ...
        from gerrit_comments.parsers import add_reply_parser
    ...
    def test_add_work_on_patch_parser(self):
        ...
        from gerrit_comments.parsers import add_work_on_patch_parser
    ...
    def test_add_finish_patch_parser(self):
        ...
        from gerrit_comments.parsers import add_finish_patch_parser
    ...
    def test_add_push_parser(self):
        ...
        from gerrit_comments.parsers import add_push_parser
...
class TestConsolidatedParsers:
    ...
    def test_abort_parser_default(self):
        ...
        from gerrit_comments.parsers import add_abort_session_parser
    ...
    def test_staged_parser_default_list(self):
        ...
        from gerrit_comments.parsers import add_staged_parser
