...
from gerrit_comments.interactive import InteractiveSession
from gerrit_comments.models import ChangeInfo, CommentThread, ExtractedComments
...
class TestInteractiveActionHandlers:
    ...
    @patch('gerrit_comments.interactive.work_on_patch')
