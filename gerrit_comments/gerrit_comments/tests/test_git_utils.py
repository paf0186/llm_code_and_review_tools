...
class TestGitRunner:
    ...
    def test_run_success(self):
        ...
        from gerrit_comments.git_utils import GitRunner
...
class TestCheckGitRepo:
    ...
    def test_valid_repo(self):
        ...
        from gerrit_comments.git_utils import check_git_repo
...
class TestGetCurrentBranch:
    ...
    def test_on_branch(self):
        ...
        from gerrit_comments.git_utils import get_current_branch
...
class TestGetCurrentCommit:
    ...
    def test_success(self):
        ...
        from gerrit_comments.git_utils import get_current_commit
...
class TestCommitExists:
    ...
    def test_exists(self):
        ...
        from gerrit_comments.git_utils import commit_exists
...
class TestHasUnmergedFiles:
    ...
    def test_has_unmerged(self):
        ...
        from gerrit_comments.git_utils import has_unmerged_files
...
class TestGetChangeIdFromCommit:
    ...
    def test_found(self):
        ...
        from gerrit_comments.git_utils import get_change_id_from_commit
...
class TestIsWorkingTreeClean:
    ...
    def test_clean(self):
        ...
        from gerrit_comments.git_utils import is_working_tree_clean
...
class TestFetchRef:
    ...
    def test_success(self):
        ...
        from gerrit_comments.git_utils import fetch_ref
...
class TestCheckout:
    ...
    def test_success(self):
        ...
        from gerrit_comments.git_utils import checkout
...
class TestCherryPick:
    ...
    def test_success(self):
        ...
        from gerrit_comments.git_utils import cherry_pick
...
class TestCherryPickAbort:
    ...
    def test_success(self):
        ...
        from gerrit_comments.git_utils import cherry_pick_abort
...
class TestCherryPickContinue:
    ...
    def test_success(self):
        ...
        from gerrit_comments.git_utils import cherry_pick_continue
...
class TestIsAncestor:
    ...
    def test_is_ancestor(self):
        ...
        from gerrit_comments.git_utils import is_ancestor
...
class TestGetCommitLog:
    ...
    def test_with_commits(self):
        ...
        from gerrit_comments.git_utils import get_commit_log
