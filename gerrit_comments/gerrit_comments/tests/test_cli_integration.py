...
class TestParserHandlerContracts:
    ...
    def test_cmd_series_parser_contract(self):
        ...
        from gerrit_comments.cli import cmd_series
        from gerrit_comments.parsers import add_review_series_parser
    ...
    def test_cmd_review_parser_contract(self):
        ...
        from gerrit_comments.parsers import add_review_parser
    ...
    def test_cmd_stage_parser_contract(self):
        ...
        from gerrit_comments.parsers import add_stage_reply_parser
    ...
    def test_all_commands_have_handlers(self):
        ...
        from gerrit_comments.parsers import setup_parsers
...
class TestGitOperationsReal:
    ...
    def test_commit_exists(self, git_repo):
        ...
        from gerrit_comments.git_utils import commit_exists, get_current_commit
    ...
    def test_checkout(self, git_repo):
        ...
        from gerrit_comments.git_utils import checkout, get_current_branch
