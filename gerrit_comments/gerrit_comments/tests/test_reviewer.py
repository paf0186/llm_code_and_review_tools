...
from gerrit_comments.models import Author, ChangeInfo
from gerrit_comments.reviewer import (
    CodeReviewer,
    DiffHunk,
    DiffLine,
    FileChange,
...
class TestCodeReviewer:
    ...
    @patch("gerrit_comments.reviewer.GerritCommentsClient")
...
class TestConvenienceFunctions:
    ...
    @patch("gerrit_comments.reviewer.CodeReviewer")
