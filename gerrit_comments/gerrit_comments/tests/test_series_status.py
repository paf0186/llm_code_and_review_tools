...
from gerrit_comments.series import PatchInfo, PatchSeries
from gerrit_comments.series_status import (
    PatchStatus,
    SeriesStatus,
    show_series_status,
)
...
class TestSeriesStatus:
    ...
    @patch("gerrit_comments.series_status.SeriesFinder")
    @patch("gerrit_comments.series_status.extract_comments")
    @patch("gerrit_comments.series_status.StagingManager")
...
class TestShowSeriesStatus:
    ...
    @patch("gerrit_comments.series_status.SeriesStatus")
