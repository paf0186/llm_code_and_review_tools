...
from gerrit_comments.extractor import CommentExtractor, extract_comments
from gerrit_comments.models import Author, Comment


class TestCommentExtractor:
    """Tests for CommentExtractor."""

    @patch("gerrit_comments.extractor.GerritCommentsClient")
...
class TestExtractCommentsFunction:
    ...
    @patch("gerrit_comments.extractor.CommentExtractor")
